...
const toggleSubscription = asyncHandler(async (req, res) => {
    ...
    if (existingRecord) {
        ...
        return res.status(200).json(new ApiResponse(200, { isSubscribed: false, subscribersCount }, "Unsubscribed successfully"));
    } else {
        ...
        const subscribersCount = await Subscription.countDocuments({ channel: channelId });
        return res.status(201).json(new ApiResponse(201, { isSubscribed: true, subscribersCount }, "Subscribed successfully"));
    }
});
