...
router.route("/all").get(optionalAuth, getAllVideos);
router.route("/tags").get(getAllTags);
router.route("/storage-usage").get(verifyJWT, getStorageUsage);
router.route("/admin/stats").get(verifyJWT, getAdminStats);
...
router.route("/get/:videoId").get(optionalAuth, getVideoDetails);
